    ...
    <div class="content">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="form-inline col-md-6" style="margin-top: 10px; float: left;">
                        ...
                        <c:forEach var="category" items="${category}">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-outline-danger btn-delete"><i class="fas fa-trash-alt"></i>
                                    </button>
                                </td>
                            </tr>
                        </c:forEach>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-center">
                            <c:choose>
                                <c:when test="${currentPage > 1}">
                                    <li class="page-item"><a class="page-link"
                                                             href="/admin/category/list?page=${currentPage-1}&limit=${limit}">Previous</a>
                                    </li>
                                </c:when>
                            ...
                            <c:if test="${currentPage > 2}">
                                <li class="page-item"><a class="page-link"
                                                         href="/admin/category/list?page=${currentPage-2}&limit=${limit}">${currentPage-2}</a>
                                </li>
                            </c:if>

                            <c:if test="${currentPage > 1}">
                                <li class="page-item"><a class="page-link"
                                                         href="/admin/category/list?page=${currentPage-1}&limit=${limit}">${currentPage-1}</a>
                                </li>
                            </c:if>

                            <li class="page-item active"><a class="page-link"
                                                            href="/admin/category/list?page=${currentPage}&limit=${limit}">${currentPage}</a>
                            </li>
                            ...
                            <c:choose>
                                <c:when test="${currentPage<totalPages}">
                                    <li class="page-item"><a class="page-link"
                                                             href="/admin/category/list?page=${currentPage+1}&limit=${limit}">Next</a>
                                    </li>
                                </c:when>
