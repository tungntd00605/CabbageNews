                    ...
                    <table class="table">
                        ...
                        <c:forEach var="article" items="${article}">
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-outline-info btn-edit" href="/admin/article/edit-article?id=<c:out value="${article.id}"></c:out>"><i class="fas fa-edit"></i></a>
                                    <a class="btn btn-outline-danger btn-delete" href="/admin/article/delete-article?id=<c:out value="${article.id}"></c:out>"> <i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
