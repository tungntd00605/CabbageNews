    ...
    <div class="col-lg-9" style="margin-left: 150px;">
        <div class="card">
            ...
            <div class="card-body card-block">
                <form action="/admin/article/edit-article" method="post" class="form-horizontal">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="url"
                                                            value="<c:out value="${editArticle.url}"/>"
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="text" name="title" placeholder="Enter Title"
                                                            class="form-control"
                                                            value="<c:out value="${editArticle.title}"/>">
                        </div>
                    </div>

                    <div class="row form-group">
                        <div class="col col-md-3"><label class=" form-control-label">Description</label></div>
                        <div class="col-12 col-md-9"><input type="text" name="description"
                                                            placeholder="Enter Description"
                                                            class="form-control" value="<c:out value="${editArticle.description}"/>">
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <textarea class="col-lg-12" name="content" id="article-editor"
                                      placeholder="Content....." value="<c:out value="${editArticle.content}"/>"></textarea>
                        </div>
