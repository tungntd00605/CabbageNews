    ...
    <div class="col-lg-9" style="margin-left: 150px;">
        <div class="card">
            ...
            <div class="card-body card-block" style="height: 400px;">
                <form action="/admin/category/edit-category" method="post" class="form-horizontal">

                    <div class="row form-group">
                        <div class="col col-md-3"><label class=" form-control-label">Category Name</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <input type="text" name="name" placeholder="Enter category name" class="form-control" value="<c:out value="${categoryDetai.name}"/>">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label class=" form-control-label">Description</label></div>
                        <div class="col-12 col-md-9">
                            <input type="text" name="description" placeholder="Enter Description" class="form-control" value="<c:out value="${categoryDetai.description}"/>">
                        </div>
                    </div>
